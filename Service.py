...
nameslist = ["Aeolus","Abraxis","Zeyta","Zalzaide","Armagus","Ibane","Gen'jin","Byron","Jaeremy","Artemisia","Judica","Adalinde","Olivia","Garth","Erebus","Marius","Daniel","Selene","Liam","Hayden","Jessica","Kayloc","Tetsedah","Soultrax","Tsoul","Anathros","Sathson","Brody","Cameron","Brock","Kevin","Alessandro","Madeline","Thomas","DelwinPraeg","Ryan","Justin","McCray","Chase","Elyse","Noah","Stephen","Carlton","Honeyglow","Austyn","Abelard","Addison","Alaire","Aleyn","Ancel","Ande","Anselm","Arnald","Arnott","Arthur","Augustine","Aylmer","Baldric","Bartholomew","Belmont","Benedict","Bernard","Berndan","Bertram","Bertrand","Bouchard","Boyle","Brice","Brien","Bryce","Cain","Caplan","Claudien","Clifton","Clive","Cuthbert","Daimbert","Dawson","Derwin","Deryk","Drew","Drystan","Eadbert","Ealdwine","Eddard","Edwyn","Eldred","Emanuel","Esmond","Esmour","Fiebras","Flambard","Foxe","Francis","Frederyk","Fulke","Ganelon","Geoffrey","Gerald","Gerbold","Goddard","Godebert","Gylbart","Gyles","Halstein","Hamon","Heinlein","Hewrey","Higelin","Ivan","Jakys","Jeger","Jeorge","Jonathas","Joseph","Josias","Kain","Kenrick","Ladislas","Laurence","Laurentius","Leavold","Lodwicke","Mansel","Marlowe","Mathye","Morys","Myles","Navarre","Noah","Olyver","Orrick","Oswyn","Parnell","Peter","Powle","Radolf","Randwulf","Reeve","Reinholdt","Reynard","Ribald","Richarde","Ridel","Roger","Samson","Sandre","Sevrin","Symon","Taran","Taylor","Templeton","Tuckard","Tywick","Valentyne","Viktor","Voyce","Vyncent","Wadard","Warin","Werner","Willielmus","Woden","Wolfstan","Xacheus","Ywain","Adela","Admiranda","Aeditha","Aelina","Agnys","Alainne","Aleria","Alyne","Alys","Alyssa","Amelia","Anna","Annabel","Anne","Arlette","Asha","Atilda","Ava","Avelin","Averille","Ayleth","Beatrix","Bertana","Carmen","Cecillia","Cecily","Celes","Celestine","Celestria","Cenota","Chloe","Christabel","Clarimond","Collys","Concessa","Cwengyth","Damaris","Dametta","Decima","Deloys","Diamanda","Dionisia","Dorcas","Edelinne","Eilonwy","Elle","Elsebee","Eltyana","Elyn","Elynor","Elyzabeth","Emblyn","Emeline","Emeny","Emeria","Emilie","Eschina","Estrild","Ethelia","Evelyn","Faye","Frances","Francisca","Garnet","Germainne","Glenda","Gloriana","Gwenneth","Helena","Helenor","Hester","Hilda","Hildegard","Imedia","Ismenia","Jacquette","Jessica","Jocea","Jocelyn","Joleicia","Jolline","Joyse","Judithe","Julia","Juliana","Kath","Katrina","Konstanze","Lauda","Leofwen","Leofwynn","Lyde","Maerwynn","Malin","Margarete","Margeria","Maronne","Martine","Mathild","Melly","Melusine","Meredithe","Merilda","Meryell","Minerva","Morgayne","Muriel","Nicia","Olyffe","Ophellia","Parnell","Patricya","Pelinne","Penelope","Petronilla","Pulmia","Rebecca","Rosa","Rosamund","Sabrine","Samantha","Sarra","Saya","Scarlet","Somerhild","Sylphie","Sylvia","Syndony","Temperance","Tess","Thomasyn","Thora","Tristana","Vega","Wenda","Wulfhilda","Wynefreede","Yve",]
