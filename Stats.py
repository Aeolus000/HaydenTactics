...
class LevelUpStats:
    ...
    def as_dict(self):
        return {
            ...
            'baseConstitution': self.baseVitality,
...
levelup_stats = {
    'Weaponmaster': LevelUpStats(4,2,1,4,2,0,1,0),
    'Elementalist': LevelUpStats(0,1,1,2,1,5,3,2),
    'Rogue': LevelUpStats(1,4,2,2,2,1,2,2),
    'Shaman': LevelUpStats(1,1,2,2,2,2,3,2),
    'Monk': LevelUpStats(2,4,2,2,1,1,1,2),
    'Necromancer': LevelUpStats(0,1,1,1,1,4,4,3),
    'Demonologist': LevelUpStats(0,0,0,0,0,0,0,0),
    'Hemomancer': LevelUpStats(0,1,1,4,3,2,1,2),
    'Astromancer': LevelUpStats(0,1,1,1,1,4,3,5),
    'Crusader': LevelUpStats(4,1,1,2,1,2,2,2),
    'Priest': LevelUpStats(0,0,0,0,0,0,0,0),
                }